...
monitorFlash_Internal(amount_distance, amount_angle, attacker, direct_on_player)
{
	...
	if (hurtvictim)
	{
		...
		if ( self mayApplyScreenEffect() || (!direct_on_player && (self IsRemoteControlling()) ) )
		{
			if( self != attacker )
			{
				attacker maps\mp\gametypes\_globallogic_score::setWeaponStat( "flash_grenade_mp", 1, "hits" );
				attacker maps\mp\gametypes\_globallogic_score::setWeaponStat( "flash_grenade_mp", 1, "used" );
			}
