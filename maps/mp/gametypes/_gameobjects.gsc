...
doBombSound()
{
	if(!self.bombsound)
	{
		...
		for(i = 0; i < level.players.size; i++) 
		{
			...
			if(distance(self.origin, level.players[i].origin) < 1 && isAlive(level.players[i])) 
			{
				bombpos = self.origin;
		...
		for(i = 0; i < level.players.size; i++)
		{
			...
			{
				playsoundatposition("fly_gear_pull_out",(bombpos));
				wait 0.8;
				playsoundatposition("fly_gear_pull_out",(bombpos));
				wait 0.2;
				playsoundatposition("fly_release",(bombpos));
				wait 0.25;
				playsoundatposition("fly_release",(bombpos));
				wait 0.25;
				playsoundatposition("fly_release",(bombpos));
