...
get_default_head()
{
	selectedclass = self.pers[ "xkmod_class" ];
	self.cac_body_type = "";
...
set_faction_for_team()
{
	...
	AssertEx( IsDefined( game["cac_faction_"+self.pers[ "team" ]] ), "CAC faction is not set for " + self.pers["team"] + " check the teamset" );
